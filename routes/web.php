...
*/
    ...
    Route::post('/allProduct', [AllProductController::class, 'index']);

    // Route::get('/allProduct', [AllProductComponent::class]);
    // Route::post('/allProduct', [AllProductComponent::class]);
    ...
    Route::get('/sub-category/{id}', SubCategoryComponent::class);
    ...
    // Route::get('/upgrade/{rowId}', [Pannier::class, "upgrade"])->name('upgrade');
    // Route::get('/degrade/{rowId}', [Pannier::class, "degrade"])->name('degrade');
