<main class="row container mx-auto">
    ...
    <div class="col-3 mt-5 d-lg-none ">
        <div class="offcanvas offcanvas-start ps-3" tabindex="-1" id="offcanvasExample"
            ...
            <div class="offcanvas-header">
                <h5 class="offcanvas-title" id="offcanvasExampleLabel">Filter by price</h5>
            ...
            <h5 class="offcanvas-title mb-2 mt-0 pt-0" id="offcanvasExampleLabel">Filter by size</h5>
            ...
            <div class="mt-3 row">
                ...
                <h5 class="offcanvas-title mb-2" id="offcanvasExampleLabel">Filter by color</h5>
    ...
    <div class="col-8">
        <p class="text-black  mt-5  titleDashboard fs-1">Product Search</p>
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <div class="text-center">
                        ...
                        <div class="d-flex justify-content-around">
                            @if ($product->promo == 1)
                                <p class="price color">{{ $product->prix_promotion }} dh
                                </p>
